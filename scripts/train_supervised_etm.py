...
from src.models.etm_supervised import MLPEncoder, Decoder, SETM
...
def parse_args():
    ...
    parser.add_argument("--model", type=str, default="setm")
...
def main(arglist):
    ...
    model = SETM(encoder, decoder, pred_sentiment=arglist["pred_sentiment"])
    ...
    if arglist["save"]:
        ...
        fig_topic = plot_topic_term(topic_term, df_vocab, topk)
        fig_topic.savefig(os.path.join(logger.save_path, f"topic_term.png"), dpi=100)
